...
var fightOrSkip = () => {
  ...
  //recursive condition call
  if (!promptFight) {
    alert("You need to choose a valid answer. Try again.");
    return fightOrSkip();
  }

  promptFight = promptFight.toLowerCase();
  if (promptFight === "skip") {
    var confirmSkip = confirm("Are you sure you'dl ike to quit?");
    // leave fight
    if (confirmSkip) {
      alert(`${playerInfo.name} has decided to skip this fight. Goodbye!`);
      //take away money if quit
